...
console.log(
    'This script populates the agent personas. Specify the database as an argument - e.g.: node populate_personsas "mongodb+srv://<username>:<password>@<cluster-address>/<database-name>?retryWrites=true&w=majority&appName=<cluster-name>"'
);
