...
export default function chapter_tools(llm) {
    ...
    `);
    const first_chapter = tool(async ({ persona, prompt_info, outline }) => {
    ...
    const next_chapter = tool(async ({ persona, prompt_info, chapter, outline }) => {
    ...
    const rewrite_chapter = tool(async ({ persona, prompt_info, critique, outline, chapter }) => {
    ...
    const critique_chapter = tool(async ({ persona, prompt_info, chapter, outline }) => {
    ...
    const vote_chapter_critique = tool(async ({ persona, prompt_info, critique_bank }) => {
    ...
    const vote_chapter = tool(async ({ persona, prompt_info, chapter_bank }) => {
        const messages = await vote_chapter_prompt.formatMessages({ persona, prompt_info, chapter_bank });
